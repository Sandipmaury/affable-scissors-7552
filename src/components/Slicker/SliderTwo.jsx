        ...
        <div className="sliderdiv">
          ...
          <Slider {...settings}>
                ...
                <div className='sliderone'>
                    ...
                    <div style={{border:'2px solid red', width:'50%', background:"#fcf4ee" }} className="tataharper_heading">
                        <h3>TATA HARPER</h3>
                        <h2>TATA HARPER</h2>
                        <a href="">LEARN MORE</a>
                    </div>
                ...
                <div className='slidertwo'>
                    ...
                    <div style={{border:'2px solid red', width:'50%', background:"white" }} className="tataharper_heading">
                      <h4>NATURA BISSE</h4>
