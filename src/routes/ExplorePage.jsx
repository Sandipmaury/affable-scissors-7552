      ...
      <div className="sectionFour_text">
        ...
        <div className="section_two_p1">
          <p>
            ...
            brands we carry (see above), we also wanted to shine a light on six
            fantastic Hispanic female founders of lines we don't sell.
          </p>
          <a href="" style={{ color: "rgb(0, 75, 145)" }}>
            Explore
          </a>
      ...
      <div className="section_seven_text">
        ...
        <div className="section_two_p3">
          <p>
            ...
            it up moment to moment, you'll discover plenty of options among our
            curated offerings.
          </p>
          <a href="" style={{ color: "rgb(0, 75, 145)" }}>
            Explore
