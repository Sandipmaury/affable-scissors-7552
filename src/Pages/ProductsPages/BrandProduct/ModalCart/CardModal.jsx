        ...
        <ModalBody>
          <Flex>
            ...
            <Box>
                ...
                <Text padding='10px 3px'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur rerum placeat modi molestiae numquam tempore doloremque doloribus aliquam suscipit voluptates.</Text>
                 <Box>
                 <Menu>
                    <MenuButton padding='10px 0px' width="100%" as={Button} rightIcon={<ChevronDownIcon />}>
                        Actions
                    </MenuButton>
                    <MenuList >
                 ...
                 <Button onClick={()=>handleAddtoCart(props)} margin="5px 0px" bgColor='#12284C' color='white' width="100%"><BsFillBagPlusFill />&#xFEFF;&#xFEFF; Add To Bag</Button>
            </Box>
          </Flex>
        </ModalBody>
        <ModalFooter>
